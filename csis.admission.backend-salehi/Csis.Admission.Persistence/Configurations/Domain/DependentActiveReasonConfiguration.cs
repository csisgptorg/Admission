...
internal sealed class DependentActiveReasonConfiguration : BaseEntityConfiguration<DependentActiveReason, short>
{
    public override void Configure(EntityTypeBuilder<DependentActiveReason> builder) {
        base.Configure(builder);

        builder.ToTable("DependentActiveReason", "Base");
