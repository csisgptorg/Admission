...
public sealed record CreateOrUpdateStudentAddressEmployeeCommand : BaseCommandDto<CreateOrUpdateStudentAddressEmployeeCommand, Address>, IRequest<int>
{
    ...
    /// <inheritdoc/>
    public override void ReverseCustomMappings(IMappingExpression<CreateOrUpdateStudentAddressEmployeeCommand, Address> mapping) {
...
internal sealed class UpdateStudentAddressEmployeeCommandHandler(
    ...
    : IRequestHandler<CreateOrUpdateStudentAddressEmployeeCommand, int>
{
    public async Task<int> Handle(CreateOrUpdateStudentAddressEmployeeCommand command, CancellationToken cancellationToken) {
