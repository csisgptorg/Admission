...
namespace Csis.Admission.Application.Features.PreachGrades.Dtos;

/// <summary>
/// مدل نمایشی موجودیت ازدواج
/// </summary>
public sealed record PreachGradeDto : BaseDto<PreachGradeDto, PreachGrade>
{
    /// <summary>
    /// Codm
    /// </summary>
    ...
    public override void CustomMappings(IMappingExpression<PreachGrade, PreachGradeDto> mapping) {
