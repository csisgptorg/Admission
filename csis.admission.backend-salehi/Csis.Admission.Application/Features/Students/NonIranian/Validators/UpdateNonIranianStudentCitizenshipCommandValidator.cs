...
public sealed class UpdateNonIranianStudentCitizenshipCommandValidator : BaseValidator<UpdateNonIranianStudentCitizenshipCommand>
{
    public UpdateNonIranianStudentCitizenshipCommandValidator() {
