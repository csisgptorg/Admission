...
/// <summary>
/// مدل نمایشی خلاصه موجودیت تکفل های غیرطلبه
/// </summary>
public sealed record NonStudentDependantAbstractDto : BaseDto<NonStudentDependantAbstractDto, NonStudentDependant>
{
    /// <summary>
    /// شناسه شخس
    /// </summary>
