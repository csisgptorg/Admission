...
/// </summary>
public sealed class RegisterDependentMarriageCommandValidator : BaseValidator<UpdateChildMarriageCommand>
{
    public RegisterDependentMarriageCommandValidator()
    {
