...
public sealed class DivorceSupervisorDataImportCommandValidator : BaseValidator<UpdateStudentSisterDivorceDataImportCommand>
{
    public DivorceSupervisorDataImportCommandValidator() {
        RuleFor(x => x.Codm)
           .NotEmpty()
        ...
        RuleFor(x => x.DivorceDate)
            ...
            .WithMessage("تاریخ طلاق معتبر نیست.");
    }
}
