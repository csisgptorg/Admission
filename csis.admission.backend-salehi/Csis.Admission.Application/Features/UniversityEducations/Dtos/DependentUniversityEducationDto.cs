...
/// تحصیلات دانشگاهی
/// </summary>
public sealed record DependentUniversityEducationDto : BaseDto<DependentUniversityEducationDto, UniversityEducation>
{
    /// <summary> </summary>
    ...
    /// <inheritdoc/>
    public override void CustomMappings(IMappingExpression<UniversityEducation, DependentUniversityEducationDto> mapping) {
