...
| **فایل‌های مستندسازی شده** | 75 | 19.0% |
| **فایل‌های باقیمانده** | 319 | 81.0% |
| **Features با حداقل یک فایل مستند** | 23 از 72 | 31.9% |
| **کلمات نوشته شده** | ~160,000 | - |
